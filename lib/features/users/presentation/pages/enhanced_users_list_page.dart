...
class _EnhancedUsersListPageState extends State<EnhancedUsersListPage>
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Users list
            Expanded(
              child: BlocBuilder<EnhancedUsersCubit, EnhancedUsersCubitState>(
            ...
            // Enhanced status bar
            BlocBuilder<EnhancedUsersCubit, EnhancedUsersCubitState>(
              builder: (context, state) {
                if (state.isOffline ||
                    state.isSyncing ||
        ...
        Container(
          ...
          child: PopupMenuButton<String>(
            ...
            onSelected: (value) async {
              switch (value) {
                case 'sync':
                  await context.read<EnhancedUsersCubit>().forceSync();
                  break;
                case 'cache_info':
                  _showCacheInfo();
                  break;
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final stats = state.getStatsForUser(user.id);
          final isLoadingStats = state.isLoadingStatsForUser(user.id);
  ...
  Widget _buildEnhancedStatusBar(
      EnhancedUsersCubitState state, ThemeData theme) {
    final colorScheme = theme.colorScheme;
  ...
  void _showCacheInfo() async {
    final cacheInfo = await context.read<EnhancedUsersCubit>().getCacheInfo();
  ...
  void _showPaginationInfo() {
    final paginationInfo =
        context.read<EnhancedUsersCubit>().getPaginationInfo();
